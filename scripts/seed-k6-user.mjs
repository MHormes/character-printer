...
// Hash once — all test users share the same password
const hash = await bcrypt.hash("K6TestUser123!", 10);
...
const characterData = (idx) => ({
  ...
  saves: {
    str: { proficient: true,  stack: [], override: null },
    dex: { proficient: false, stack: [], override: null },
    con: { proficient: true,  stack: [], override: null },
