...
import { ExhaustionTrackerWidget } from "@/components/canvas/widgets/exhaustion-tracker-widget";
import { ReactionUsedWidget } from "@/components/canvas/widgets/reaction-used-widget";
import { ConcentrationTrackerWidget } from "@/components/canvas/widgets/concentration-tracker-widget";
...
import { AttunedItemsWidget } from "@/components/canvas/widgets/attuned-items-widget";
...
function WidgetContent({ type, spellId, spellStartIndex, spellCount, featureId, statId, trackerId, textSource }: { type: WidgetType; spellId?: string; spellStartIndex?: number; spellCount?: number; featureId?: string; statId?: string; trackerId?: string; textSource?: string }) {
  ...
  if (type === "ExhaustionTracker") return <ExhaustionTrackerWidget />;
  if (type === "ReactionUsed") return <ReactionUsedWidget />;
  if (type === "ConcentrationTracker") return <ConcentrationTrackerWidget />;
  ...
  if (type === "AttunedItems") return <AttunedItemsWidget />;
