...
// Matches ToolProficienciesWidget viewBox width (164) so text scales identically
const C1 = 90;
const C2 = 115;
const RIGHT = 161;
...
// SVG height: 3 top + 14 header + n×13 rows + 1 padding
...
export function SlimToolProfWidget() {
  ...
  return (
    ...
    >
      <DndFrame x={3} y={3} w={158} h={frameH} cornerOff={10} />
