...
export function ConcentrationTrackerWidget() {
  ...
  return (
    ...
    >
      ...
      {/* Spell/effect name: caption, then blank line to write on */}
      <text x="65" y="20" textAnchor="middle" dominantBaseline="middle"
        fontSize="6" fontFamily={ff} fontStyle="italic" letterSpacing="0.3" fill="#6a5a48"
      >Concentrating on...</text>
      <line x1="18" y1="55" x2="112" y2="55" stroke="#1a1208" strokeWidth="0.6" />

      <line x1="8" y1="128" x2="122" y2="128" stroke="#1a1208" strokeWidth="0.5" />

      {/* Rounds-left: blank space above the label, filled in by hand */}
