                    ...
                    >
                      <div className="flex min-w-0 flex-1 flex-col gap-1">
                        ...
                        <DynamicValueInput
                          ...
                          level={level}
                          pb={proficiencyBonus}
                          onChange={(v, vs, vm, vo) => updatePassiveMod(mod.id, { value: v, valueSource: vs, valueMultiplier: vm, valueOffset: vo })}
                        />
                      </div>
                  ...
                  >
                    <div className="flex min-w-0 flex-1 flex-col gap-1">
                      ...
                      <DynamicValueInput
                        ...
                        level={level}
                        pb={proficiencyBonus}
                        onChange={(v, vs, vm, vo) => updateGlobalMod(mod.id, { value: v, valueSource: vs, valueMultiplier: vm, valueOffset: vo })}
                      />
                    </div>
                    <div className="mt-0.5 flex flex-col gap-0.5">
                      <button
