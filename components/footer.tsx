    ...
    <footer className="border-t border-border px-8 py-4">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-3 max-w-screen-2xl mx-auto">
        <span className="font-cinzel text-[10px] tracking-[0.35em] uppercase text-muted-foreground">
          Print2Play &mdash; D&amp;D 5e
        </span>
        <div className="flex items-center gap-5">
          <Link
            href="/privacy"
            className="font-garamond text-xs text-muted-foreground hover:text-foreground transition-colors"
          >
            Privacy Policy
          </Link>
          <Link
          ...
          <a
            href="https://buymeacoffee.com/mhormes"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-foreground transition-colors"
